...
export function App() {
  ...
  var [dataSelecionadaNoCalendario, setDataSelecionadaNoCalendario] = useState({
    dia: dataAtualDoSistema.getDate(),
    mes: dataAtualDoSistema.getMonth(),
    ano: 0,
  })
  ...
  return (
    <main class='mainContainer bg-neutral-900 scrollbar scrollbar-thumb-rose-500 '>
